        ...
        <View style={styles.logoContainer}>
          <TouchableOpacity style={styles.logoCover}>
            <Image
              resizeMode="contain"
              style={styles.logo}
              source={require("../../assets/darkAssets/profile.png")}
            />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.moreContainer}>
          <TouchableOpacity style={styles.moreCover}>
            <Image
              resizeMode="contain"
              style={styles.more}
              source={require("../../assets/darkAssets/newPost-more.png")}
            />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.addItemContainer}>
        ...
        >
          <TouchableOpacity style={styles.addItemCover} onPress={selectImage}>
            <Image
              resizeMode="contain"
              style={styles.addItemLogo}
              source={require("../../assets/darkAssets/newPost-addImage.png")}
            />
          </TouchableOpacity>
          <TouchableOpacity style={styles.addItemCover}>
            <Image
              resizeMode="contain"
              style={styles.addItemLogo}
              source={require("../../assets/darkAssets/newPost-addLocation.png")}
            />
          </TouchableOpacity>
          <TouchableOpacity style={styles.addItemCover}>
            <Image
              resizeMode="contain"
              style={styles.addItemLogo}
              source={require("../../assets/darkAssets/newPost-addEmotion.png")}
            />
          </TouchableOpacity>
        </View>
